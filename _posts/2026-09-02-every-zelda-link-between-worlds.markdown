---
layout: post
title: "Every Zelda: A Link Between Worlds"
date: 2026-09-02 06:00:00 +0000
categories: gaming
---
...
I ended up playing this on my hardware 3DS so I only have limited screenshots to liven up this article, which are bad "phone photo of the 3DS screen" shots. But I got the proof of 100% completion.

![Final stats]({{site.url}}/assets/every_zelda/albw_stats.jpg)

## What Happens

A probably too wordy summary of the game's plot:
...
In the past I've been pretty high on ALBW. This playthrough put me slightly lower on it, but like a 9/10 instead of a 10/10.

ALBW has a more open world structure than most Zelda games, especially in the second half where you can go to the 7 Lorule dungeons in *mostly* any order. This is driven by the item rental system, which is a nice twist on the classic Zelda formula. Having the ability to just get any item and do 90% of the puzzles in the game from pretty early on is great, especially on a replay. It also gives the dungeons a different vibe as you don't spend the first half of the dungeon trying to find the main item to unlock all the puzzles. Instead the dungeons tend to feel more linear, as you just grind through the dungeon. There are big chests with optional upgrade items in most of the dungeons which provide a nice bit of dopamine midway through.

The main gimmick of this game, merging with walls, is very well done. It never feels stale through the whole game, and has endless uses. It feels like a "rune" from Breath of the Wild or Tears of the Kingdom, but even more widly applicable than the best of those. The "magic meter" refilling fairly quickly and being shared between all items also works really well to encourage you to use your items consistently. They got the balance right where you rarely feel like you just need to wait for it to refill.

My main criticisms of the game are that it feels fairly easy, even though it has the unique rental death mechanic going on, and that none of the dungeons or items (other than the wall merging) feel really standout and unique. It's possible I should have played on "Hero" difficulty.

Had a lot of fun overall.

## Sidquests and Stuff

Not too crazy to get 100% in this one. Partly this is because a good chunk of the side content are random puzzle dungeons that just reward rupees. I did all of these that I came across but it's definitely possible I missed some. There's no way to track it, especially since I ended up with 9999 rupees anyway.

![Final hearts]({{site.url}}/assets/every_zelda/albw_hearts.jpg)

You finish with 20 heart containers in this game: start with 3, 10 from dungeons, and 7 more from 28 heart pieces sprinkled throughout the game. It felt like there are quite a lot that are just "have a specific item in a specific place" which could be obtained basically at any time. There are also a standard selection that come from minigames.

Speaking of minigames, there are a few and none of them were terrible. My least favourite was the the "Octoball Derby" which is basically baseball, but even that I managed after a few attempts. There's pure gambling, "Rupee Rush" which was fine, and "Treacherous Tower".

Treacherous Tower is a combat minigame where you go through a number of floors (5, 20, and then 50 on different difficulties), each of which is filled with enemies in preset patterns. It's fun enough but they decided to make half the floors icy, which is annoying, and the 50 floor version is a little long. This is made worse by the fact you need to do it twice. The middle difficulty rewards a heart piece but the 50 floor difficulty rewards upgrades for your lamp and bug net over 2 completions. These upgrades are pretty useless because even with the upgrades, they're not worth using over "real" items. It also rewards 5k rupees per completion which is how I ended up with 9999 rupees at the end of the game.

![Final gear]({{site.url}}/assets/every_zelda/albw_gear.jpg)

The final elephant in the room is the Maiamai sidequest. You can meet Mother Maiamai early on, and she asks you to round up her children. A maiamai, by the way, is a weird octopus creature that wears a shell on its head, and seems to be made up for this game. These are sprinkled around the game quite liberally, 100 in total. You find them hidden on various bits of scenery, such as by charging into trees, lifting rocks, or using wall merge to pop them off walls. You get annotations on the map to show you how many are in each area, and they make a fairly loud sound when nearby, which was enough info for me to get them all without a guide. I found around 60 just by playing and picking them up and had to round up the remainder in a focused sweep near the end of the game.

The best part of this sidequest is the rewards. For every 10 maiamais rescued, Mother Maiamai will permanently upgrade one of your items (that you need to have purchased outright). This will do stuff like make the bow shoot a spread of 3, make the bombs explosion larger, etc. For the full 100 she gives you an upgraded spin attack, which hits most of the screen. Very useful for Treacherous Tower. Very cool rewards, really motivating for me (unlike the useless upgrades from Treacherous Tower).
